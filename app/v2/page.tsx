...
const startupCoreServices = [
  { num: "01", title: "Pitch Deck Creation",               desc: "Investor-ready presentations that open wallets.",       href: "/v2/startup-services/pitch-deck" },
  { num: "02", title: "Business Plan & Financial Modeling", desc: "Five-year growth blueprints backed by real projections.", href: "/v2/startup-services/business-plan" },
];

const exportCoreServices = [
  { num: "03", title: "Documentation Service",           desc: "IEC, GST+PAN, AD Code, RCMC — handled end-to-end.",      href: "/v2/export-services/documentation" },
  { num: "04", title: "Freight Forwarding & Logistics",  desc: "Sea, air, road — global cargo movement, customs cleared.", href: "/v2/export-services/freight-forwarding" },
  { num: "05", title: "International Banking Support",   desc: "Forex accounts, Letters of Credit, cross-border payments.", href: "/v2/export-services/international-banking" },
];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <AnimateOnScroll animation="slide-left">
                ...
                <div className="space-y-3 mb-8">
                  <Link href="/v2/startup-services/pitch-deck"
                  ...
                  <Link href="/v2/startup-services/business-plan"
                    className="flex items-center justify-between p-4 border-2 border-brand-200 bg-brand-50 rounded-xl hover:border-brand-500 hover:bg-brand-100/50 transition-all group">
                    <div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <AnimateOnScroll animation="slide-right" delay={100} className="order-1 lg:order-2">
                ...
                <div className="space-y-3 mb-8">
                  {[
                    { href: "/v2/export-services/documentation",        label: "Documentation Service",             sub: "Core service — IEC, RCMC, AD Code & more" },
                    { href: "/v2/export-services/freight-forwarding",   label: "Freight Forwarding & Logistics",    sub: "Core service — global cargo movement" },
                    { href: "/v2/export-services/international-banking", label: "International Banking Support",     sub: "Core service — forex, LC, remittance" },
                  ].map((l) => (
