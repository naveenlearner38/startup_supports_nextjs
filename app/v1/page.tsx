...
import HeroCards from "@/components/v1/HeroCards";
import MarqueeV1 from "@/components/v1/MarqueeV1";
...
const capabilities = [
  ...
  },
  {
    ...
    href: "/v1/export-services/documentation",
  },
  {
    n: "03",
    ...
    href: "/v1/export-services/freight-forwarding",
  },
  {
    n: "04",
    ...
    href: "/v1/export-services/international-banking",
  },
];
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { label: "Documentation", sub: "IEC · RCMC · AD Code", href: "/v1/export-services/documentation" },
                  { label: "Freight", sub: "Sea · Air · Road", href: "/v1/export-services/freight-forwarding" },
                  { label: "Banking", sub: "LC · Forex · e-BRC", href: "/v1/export-services/international-banking" },
                  { label: "Compliance", sub: "Advisory & Support", href: "/v1#export" },
                ].map((item, i) => (
